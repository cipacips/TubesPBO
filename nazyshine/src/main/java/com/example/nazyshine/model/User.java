...
/**
 * Abstract class representing a generic user in the Nazyshine application.
 *
 * <p>This class serves as the base class for all user types in the system, such as
 * customers and administrative staff (Pegawai). It provides common properties
 ...
 */
@Entity
@Table(name = "user_account") // Explicitly setting table name, avoiding 'user' which is a reserved keyword in some DBs
