    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/dashboard_customer/**").hasRole("CUSTOMER") // Restricts access to CUSTOMER role
                        .requestMatchers("/dashboard_pegawai/**").hasRole("PEGAWAI") // Restricts access to PEGAWAI role
